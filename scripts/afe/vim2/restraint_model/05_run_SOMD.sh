#!/bin/bash
#SBATCH -o /home/jguven/projects/alchemistry/vim2/logs//%x_%a.slurm.out
#SBATCH -e /home/jguven/projects/alchemistry/vim2/logs//%x_%a.slurm.err
#SBATCH -n 1
#SBATCH --gres=gpu:1
...
engine=SOMD
repeats=3 
outputs_dir=/home/jguven/projects/alchemistry/vim2//outputs/
