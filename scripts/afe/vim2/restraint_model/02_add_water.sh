...
#SBATCH -o /home/jguven/projects/alchemistry/vim2/logs//add_water_%a.slurm.out
#SBATCH -e /home/jguven/projects/alchemistry/vim2/logs//add_water_%a.slurm.err
...
python $MEZEHOME/solvate.py "$ligand" /home/jguven/projects/alchemistry/vim2/afe//protocol.dat
